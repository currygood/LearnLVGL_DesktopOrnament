...
/** Swap the 2 bytes of RGB565 color. Useful if the display uses different byte order. */
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH "/img/"         /**< Set the working directory. File/directory paths will be appended to it. */
